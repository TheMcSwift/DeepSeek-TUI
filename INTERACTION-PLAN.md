...
| **P2（打磨）** | 1.7 图片 · 1.8 长消息折叠 · 2.4 历史持久化 · 2.5 大粘贴 · 3.5–3.7 · 5.2 子代理 · 5.3 反馈 · 6.1/6.3 | 锦上添花 | ✅ 已完成（3.6 后续经 T5③ 升级：`DSH_TUI_THEME=auto` 显式启用 OSC 11 自动明暗探测 + 300ms 回退；6.3 为文本级 `toMatchSnapshot` 快照，未引入 @danypops/pi-tui-harness） |
